...
resource "google_iam_workload_identity_pool_provider" "truefoundry_platform_feature_oidc_provider" {
  ...
  attribute_condition = var.service_account_keyless_k8s_serviceaccount_name == "*" ? null : "google.subject == \"system:serviceaccount:${var.service_account_keyless_k8s_serviceaccount_namespace}:${var.service_account_keyless_k8s_serviceaccount_name}\""
}

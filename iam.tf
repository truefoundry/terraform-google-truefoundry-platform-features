...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_secret_manager_role" {
  ...
  project     = var.project
  role_id     = replace("${local.truefoundry_platform_resources}_bucket_secret_manager_role", "-", "_")
  title       = replace("${local.truefoundry_platform_resources}_bucket_secret_manager_role", "-", "_")
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_gcs_bucket_role" {
  ...
  project     = var.project
  role_id     = replace("${local.truefoundry_platform_resources}_bucket_gcs_role", "-", "_")
  title       = replace("${local.truefoundry_platform_resources}_bucket_gcs_role", "-", "_")
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_cluster_integration_role" {
  ...
  project     = var.project
  role_id     = replace("${local.truefoundry_platform_resources}_cluster_integration_role", "-", "_")
  title       = replace("${local.truefoundry_platform_resources}_cluster_integration_role", "-", "_")
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_artifact_registry_role" {
  ...
  project     = var.project
  role_id     = replace("${local.truefoundry_platform_resources}_artifact_registry_role", "-", "_")
  title       = replace("${local.truefoundry_platform_resources}_artifact_registry_role", "-", "_")

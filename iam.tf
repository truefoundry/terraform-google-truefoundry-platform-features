...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_secret_manager_role" {
  ...
  title       = substr("truefoundry/${var.cluster_name}/platform-features/${local.truefoundry_platform_resources}_bucket_secret_manager_role", 0, 100)
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_gcs_bucket_role" {
  ...
  title       = substr("truefoundry/${var.cluster_name}/platform-features/${local.truefoundry_platform_resources}_bucket-gcs-role", 0, 100)
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_cluster_integration_role" {
  ...
  title       = substr("truefoundry/${var.cluster_name}/platform-features/${local.truefoundry_platform_resources}_cluster_integration_role", 0, 100)
...
resource "google_project_iam_custom_role" "truefoundry_platform_feature_artifact_registry_role" {
  ...
  title       = substr("truefoundry/${var.cluster_name}/platform-features/${local.truefoundry_platform_resources}_artifact_registry_role", 0, 100)

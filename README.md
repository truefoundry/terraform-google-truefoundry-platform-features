...
| [google_service_account.truefoundry_platform_feature_service_account](https://registry.terraform.io/providers/hashicorp/google/latest/docs/data-sources/service_account) | data source |
...
| <a name="input_existing_service_account_email"></a> [existing\_service\_account\_email](#input\_existing\_service\_account\_email) | Use existing service account email. If service\_account\_enabled is false, this variable is required. IMPORTANT: This will override the IAM bindings for the serviceaccount passed in existing\_service\_account\_email. To avoid this, please set service\_account\_iam\_binding\_enabled to false. | `string` | `""` | no |
| <a name="input_existing_service_account_project"></a> [existing\_service\_account\_project](#input\_existing\_service\_account\_project) | GCP project of the existing service account. Required when existing\_service\_account\_email belongs to a different project than var.project. | `string` | `""` | no |
...
| <a name="input_service_account_iam_binding_enabled"></a> [service\_account\_iam\_binding\_enabled](#input\_service\_account\_iam\_binding\_enabled) | Enable service account IAM binding. If service\_account\_enabled is false, this variable will override the IAM bindings for the serviceaccount passed in existing\_service\_account\_email. | `bool` | `true` | no |
...
| <a name="input_service_account_keyless_k8s_serviceaccount_namespace"></a> [service\_account\_keyless\_k8s\_serviceaccount\_namespace](#input\_service\_account\_keyless\_k8s\_serviceaccount\_namespace) | Kubernetes namespace of the service account that will impersonate the GCP service account. Required when service\_account\_keyless\_enabled is true | `string` | `"truefoundry"` | no |
...
| <a name="input_service_account_keyless_pool_enable_override"></a> [service\_account\_keyless\_pool\_enable\_override](#input\_service\_account\_keyless\_pool\_enable\_override) | Enable overriding the workload identity pool ID. You need to pass service\_account\_keyless\_pool\_override\_id to set the pool ID. | `bool` | `false` | no |
| <a name="input_service_account_keyless_pool_override_id"></a> [service\_account\_keyless\_pool\_override\_id](#input\_service\_account\_keyless\_pool\_override\_id) | Workload identity pool ID. Only used if service\_account\_keyless\_pool\_enable\_override is enabled. | `string` | `""` | no |
| <a name="input_service_account_keyless_provider_enable_override"></a> [service\_account\_keyless\_provider\_enable\_override](#input\_service\_account\_keyless\_provider\_enable\_override) | Enable overriding the workload identity pool provider ID. You need to pass service\_account\_keyless\_provider\_override\_id to set the provider ID. | `bool` | `false` | no |
| <a name="input_service_account_keyless_provider_override_id"></a> [service\_account\_keyless\_provider\_override\_id](#input\_service\_account\_keyless\_provider\_override\_id) | Workload identity pool provider ID. Only used if service\_account\_keyless\_provider\_enable\_override is enabled. | `string` | `""` | no |
